...
{
    public class ZonepawnEditor
    {
        private Map map;

        public ZonepawnEditor(Map map)
        {
            this.map = map;
        }
        ...
        public void Show()
        {
            ...
            PropertyDescriptor pd = TypeDescriptor.GetProperties(map)["SpawnsZone"];
            ...
            editor.EditValue(serviceProvider, serviceProvider, map.SpawnsZone);
        }
    }
}
